...
public class UtilClass<HttpURLConnection> {
	...
	public void AddingItemToCart() throws InterruptedException, IOException {
		...
		WebElement product = driver.findElement(By.xpath("//*[@data-sku-id = '6406513' and contains(text(), 'Add to Cart')]"));
		JavascriptExecutor jsExecutor = ((JavascriptExecutor) driver);
		jsExecutor.executeScript("window.scrollTo(0,700)", product.getLocation().x, product.getLocation().y);
		product.click();
	...
	public void SelectFromShopBy() throws IOException {
		...
		WebElement refrigerators = driver.findElement(
				By.xpath("//a[@href=\"/site/home-appliances/refrigerators/abcat0901000.c?id=abcat0901000\"]"));
		refrigerators.click();
	...
	public void SelectFromBrands() throws InterruptedException, IOException {
		...
		WebElement addToCartButton2 = driver.findElement(By.xpath("//button[@data-sku-id='6547490' and contains(text(), 'Add to Cart')]"));

		JavascriptExecutor jsExecutor = ((JavascriptExecutor) driver);
		jsExecutor.executeScript("window.scrollTo(0,600)", addToCartButton2.getLocation().x, addToCartButton2.getLocation().y);
	...
	public void NavigateCheckoutAndDummyPayment() {
		...
		WebElement addToCartButton2 = driver.findElement(By.xpath("//button[@data-sku-id='6514055' and contains(text(), 'Add to Cart')]"));
		addToCartButton2.click();
		...
		WebElement continueasGuest = driver.findElement(By.xpath("//*[contains(@class, 'c-button c-button-secondary c-button-lg cia-guest-content__continue guest')]"));
		continueasGuest.click();

		WebElement switchalltodelivery = driver.findElement(By.xpath("//button[@class='c-button-link card-call-to-action-button']"));
		switchalltodelivery.click();

		WebElement firstname2 = driver.findElement(By.xpath("//input[@class='tb-input' and @id='firstName']"));
		firstname2.click();

		WebElement lastname2 = driver.findElement(By.xpath("//*[@class='tb-input' and @id='lastName']"));
		lastname2.click();

		WebElement address2 = driver.findElement(By.xpath("//*[@class='tb-input  autocomplete__input' and @role='combobox']"));
		address2.click();

		WebElement city = driver.findElement(By.xpath("//*[@class='tb-input' and @id='city']"));
		city.click();

		WebElement state = driver.findElement(By.xpath("//*[@class='tb-select' and @id='state']"));
		state.click();

		WebElement zipcode = driver.findElement(By.xpath("//*[@class='tb-input' and @id='zipcode']"));
		zipcode.click();

		WebElement apply = driver.findElement(By.xpath("//span[text()= 'Apply']"));
		apply.click();

		WebElement useremailaddress = driver.findElement(By.xpath("//*[@class='tb-input' and @id='user.emailAddress']"));
		useremailaddress.click();

		WebElement userphonenumber = driver.findElement(By.xpath("//*[@class='tb-input' and @id='user.phone']"));
		userphonenumber.click();

		WebElement continuetoscheduledelivery = driver.findElement(By.xpath("//span[text()='Continue to Schedule Delivery']"));
		continuetoscheduledelivery.click();

		WebElement creditcardordebitcardnumber = driver.findElement(By.xpath("//input[contains(@class, 'tb-input') and contains(@class, 'v-medium') and @pattern='[0-9]*']"));
		creditcardordebitcardnumber.click();

		WebElement expirationmonth = driver.findElement(By.xpath("//select[@class='tb-select' and @id='expMonth']"));
		expirationmonth.click();

		WebElement expirationyear = driver.findElement(By.xpath("//select[@class='tb-select' and @id='expYear']"));
		expirationyear.click();

		WebElement securitycode = driver.findElement(By.xpath("//input[contains(@class, 'tb-input') and contains(@class, 'v-medium') and @id='cvv']"));
		securitycode.click();

		WebElement placeyourorder = driver.findElement(By.xpath("//span[text() = 'Place Your Order']"));
		placeyourorder.click();

		WebElement continuetopaymentinformation = driver.findElement(By.xpath("//span[text()='Continue to Payment Information']"));
